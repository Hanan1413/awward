...
useGSAP(() => {
  // Correctly setting the clipPath on the target element
      ...
      >
        <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
          <div
            ...
            className="origin-center  cursor-pointer scale-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100"
          >
            <video
              ref={nextVideoRef}
